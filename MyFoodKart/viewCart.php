...
<head>
    ...
    <title>Kart | Yücel Cafe&Restaurant</title>
...
<br>
        ...
        <h1>Sepetim</h1><br><hr width="84%" style="margin: auto;"><br>
        <div class="container">
            <table>
                <thead>
                    <tr>
                        ...
                        <th>
                            <form action="_manageCart.php" method="POST">
                                ...
                                <button name="removeAllItem" class="rmall-btn">Temizle</button>
                ...
                <tbody>
                    <?php    //kullanıcının sepetindeki her bir ürünün ayrıntılarını görmeyi sağlayan kısım
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo '<tr>
                                            ...
                                            <center><td class="remove">
                                                <form action="_manageCart.php" method="POST">
                                                    <button name="removeItem" >Sil</button>
                                                    <input type="hidden" name="itemId" value="' . $itemId . '">
        ...
        <div class="order-container">
            <h2>Sipariş Özeti</h2><br><hr><br>
            <ul>
                <li>Toplam Ücret = <?php echo $totalPrice?>₺</li>
                <li>Kargo Ücreti =  0₺</li>
                <li>
                    <strong>Genel Toplam (kargo ve vergi ücretleri dahil) = 
                     <?php echo $totalPrice ?>₺</strong>
                </li>
            </ul>
            <div class="hello">
                ...
                <label for="flexRadioDefault1">
                    Online 3D Secure Ödeme
                </label>
                <p class="disabled">(Onlice ödemeler kısa süreli devre dışı bırakıldı)</p>
                <?php $_SESSION['amount'] = $totalPrice?>
                <div>
                <a href="checkout.php"><button type="button" data-toggle="modal" data-target="#checkoutModal" class="checkout-btn">Ödeme Sayfasına Git</button></a>
                </div>
            </div>
