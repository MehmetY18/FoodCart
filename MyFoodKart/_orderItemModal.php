<?php include 'configfortwoconnection.php'; /*PHP dosyalarında tekrar tekrar aynı bağlantı bilgilerini yazmak yerine bu kısa yöntem kullanılıyor*/ ?>
    <?php 
session_start();
...
<?php 
 // userId'ye ait olan tüm siparişleri getirmek için kullanılan kısım
...
<div id="orderItem<?php echo $orderid; ?>" tabindex="-1" role="dialog" aria-labelledby="orderItem<?php echo $orderid; ?>" aria-hidden="true">
                <h5 id="orderItem<?php echo $orderid; ?>">Sipariş öğeleri</h5>
                    ...
                    <span aria-hidden="true">&times;</span>
                            ...
                            <thead>
                                ...
                                <th scope="col" class="border-0 bg-light">
                                    <div class="px-3">Ürün</div>
                                </th>
                                <th scope="col" class="border-0 bg-light">
                                    <div class="text-center">Miktar</div>
                                </th>
                                </tr>
                            </thead>
                            <tbody>
