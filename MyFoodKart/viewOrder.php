...
<head>
    ...
    <title>Siparişlerim | Yücel</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="container">
            <div class="table-wrapper" id="empty">
                ...
                <table class="table table-striped table-hover text-center">
                    ...
                    <tbody>
                        <?php //kullanıcıya ait olan tüm siparişleri görmeyi sağlayan kısım
