...
<meta charset="UTF-8">
    ...
    <title>Ödemeler | Yücel Cafe&Restaurant</title>
...
<br>
    ...
    <div class="modal fade" id="checkoutModal" tabindex="-1" role="dialog" aria-labelledby="checkoutModal" aria-hidden="true">
        <br><h2>Siparişinizi onaylamadan önce</h2>
        <h2>bilgilerinizi giriniz</h2><br><hr><br>
        <div>
            <form action="_manageCart.php" method="post">
                <!-- <b><label for="address">Address:</label></b> -->
                <input id="address" name="address" placeholder="Adres Açıklaması 1" type="text" required minlength="3" maxlength="500">
                <!-- <b><label for="address1">Address Line 2:</label></b> -->
                <input id="address1" name="address1" placeholder="Adres Açıklaması 2" type="text">
                <!-- <b><label for="phone">Phone No:</label></b> -->
                <input type="tel" id="phone" name="phone" placeholder="Telefon No" required pattern="[0-9]{10}" maxlength="10">
                <!-- <b><label for="zipcode">Pin Code:</label></b> -->
                <input type="text" id="zipcode" name="zipcode" placeholder="Pin Kodu" required pattern="[0-9]{6}" maxlength="6">
                <!-- <b><label for="password">Password:</label></b> -->
                <input id="password" name="password" placeholder="Şifre" type="password" required data-toggle="password">
                <div class="btns">
                    <a href="viewcart.php"><button type="button" data-dismiss="modal" class="last-btns">Siparişi İptal Et</button></a>
                    <input type="hidden" name="amount" value="<?php echo $totalPrice ?>">
                    <button type="submit" name="checkout" class="last-btns">Siparişi onayla</button>
                </div>
             </form>
        </div>
</div>
